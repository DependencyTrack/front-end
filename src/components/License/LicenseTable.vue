...
<script>
  export default {
    ...
    data() {
      return {
        items: [
          {name: 'abhi', license: '0BSD', osi: '', fsf: ''},
          {name: 'CTF2', license: '389-exception', osi: '', fsf: ''},
        ],
        fields: [
          {key: 'name', label: 'Name', sortable: true, sortDirection: 'Name'},
          {key: 'license', label: 'SPDX License ID', sortable: true, class: 'text-center'},
          {key: 'osi', label: 'OSI Approved'},
          {key: 'fsf', label: 'FSF Libre'}
        ],
        totalRows: 1,
        currentPage: 1,
        perPage: 5,
