...
<script>
  export default {
    ...
    data() {
      return {
        items: [
          {scan: '', version: 26, name: 'abhi', bom: '', vul: {1: 10, 2: 2, 3: 4, 4: 12}},
          {scan: '', version: 22, name: 'CTF2', bom: '', vul: {1: 0, 2: 5, 3: 1, 4: 7}},
        ],
        fields: [
          {key: 'name', label: 'Project Name', sortable: true, sortDirection: 'Name'},
          {key: 'version', label: 'Version', sortable: true, class: 'text-center'},
          {key: 'scan', label: 'Last scan import'},
          {key: 'bom', label: 'Last BOM import'},
