<template>
  <div>
    <b-container fluid style="background-color: #FFFFFF;">
      ...
      <b-row>
        <b-col>
          <b-btn @click="createModal()" class="btn-blue">Add Dependency</b-btn>
          <b-btn @click="removeModal()" class="btn-blue">Remove Dependency</b-btn>
          <b-btn @click="uploadBOMModal()" class="btn-blue">Upload BOM</b-btn>
        </b-col>
      </b-row>
      <br>
      <b-row>
      ...
      >
        ...
        >
          <template>
            <label style="float: left;">
              <b-form-checkbox @input="bulkDataValues" v-model="bulkData" v-bind:value="row.item.name"
                               class="mb-2 mr-sm-2 mb-sm-0"></b-form-checkbox>
            </label>
        ...
        <template slot="version" slot-scope="row">
          ...
          <span v-b-tooltip.hover
                    :title=" row.item.name ">
            <font-awesome-icon icon="exclamation-triangle" class="fa-1x" />
          </span>
        </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          {key: 'select'},
          {key: 'name', label: 'Component', sortable: true, sortDirection: 'Name'},
