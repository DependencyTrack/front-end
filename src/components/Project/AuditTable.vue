...
<script>
  export default {
    ...
    data() {
      return {
        items: [
          {group: '', version: 26, component: 'abhi', license: '', vul: 'SQL INjection', cwe: 89, sev:4,analysis: '', suppressed: ''},
          {group: '', version: 22, component: 'CTF2', license: '', vul: 'CSRF', cwe: 79, sev:3, analysis: '', suppressed: ''},
        ],
        fields: [
          {key: 'component', label: 'Component', sortable: true, sortDirection: 'Name'},
